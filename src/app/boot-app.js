...
export async function bootApp() {
  ...
  const enterPlugins = makeEnterPlugins();
  const { chatLogEditor: chatLogEditorInstance, chatInputEditor: chatInputEditorInstance } = await initMilkdown({ chatLog, chatInput, inputPlugins: enterPlugins });
